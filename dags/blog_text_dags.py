...
def crawl_blog_texts():
    node = 'blog'
    categories = ['학교', '운동장', '교실', '강당', '교회', '절', '마을회관', '문방구', '슈퍼마켓', '이발소', '목욕탕', '정류장', '기차역', '버스', '시골집', '바닷가', '놀이터', '공원', '텃밭', '집안', '마루', '부엌', '창가', '골목길', '다락방',
            '국민학교', '책가방', '오락기', '뽑기', '구슬치기', '딱지', '종이학', '추억사진', '낡은앨범', '흑백사진', '고무줄', '조개껍데기', '필름카메라', '편지봉투', '만화책', '쌍쌍바', '라디오사연', 'LP판', '손풍기', '라면박스', '연탄재', '뻥튀기', '리어카', '종이신문', '전화기', '삐삐', '청바지', '노란색우비', '냉장고', '비누곽',
            '모내기', '추수', '벼', '논', '밭', '장독대', '우물', '장마', '낙엽', '눈사람', '김장', '메주', '아궁이', '감', '무', '배추', '수확', '여름방학', '겨울방학', '연날리기']
