...
def crawl_blog_texts():
    ...
    category_groups = {
       "가전제품" : ["무선충전", "블루투스", "무선인터넷", "LTE", "5G", "충전케이블", "데이터케이블", "이어폰잭", "노트북터치패드", "웹캠", "HDMI", "USB-C", "전원버튼", "재부팅", "디스플레이", "유선연결", "셋톱박스", "와이파이", "공유기", "데이터속도", "SSD", "HDD", "램", "바이오스", "운영체제", "윈도우", "안드로이드", "iOS", "그래픽카드", "CPU", "쿨러", "파워서플라이", "네트워크설정", "백신프로그램", "소프트웨어", "하드웨어", "펌웨어", "프로세서", "해상도", "디지털기기", "리눅스", "클라우드", "백업", "저장장치", "디지털화", "가상현실"]
